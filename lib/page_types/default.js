		...
		return [
			{
				...
				data:
				{
					...
					title: '#page_name#',
					lead: '',
					content: '<ul><li><strong>Page template:</strong> #source_template#</li><li><strong>Source:</strong> <a href="#source_url#">#source_url#</a></li><li><strong>Import page type:</strong> default</li></ul>' +
