		...
		return [
			{
				...
				data:
				{
					...
					title: '#page_name#',
					lead: '',
					content: '<ul><li><strong>Page template:</strong> #source_template#</li><li><strong>Source:</strong> <a href="#source_url#">#source_url#</a></li><li><strong>Import page type:</strong> multipage</li></ul>' +
                             extract_between( body , '<!-- InstanceBeginEditable name="MainContent" -->' , '<!-- InstanceEndEditable -->' ),
				},
			},
		];
	},
