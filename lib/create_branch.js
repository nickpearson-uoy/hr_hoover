...
export default async function create_branch( page , parent_id , path = '' )
{
	...
	.then( section_id =>
	{
		...
		if( page.slug )
		{
			return set_section_options( section_id , page.slug , page.show_in_nav )
		}
...
function set_section_options( section_id , output_uri , show_in_nav )
{
